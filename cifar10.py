# This file is modified from "https://github.com/pytorch/vision/blob/master/torchvision/datasets/cifar.py".
...
import numpy as np
import sys
import pickle  # for Python3 only
...
class CIFAR10(data.Dataset):
    ...
    def __init__(self, root, data_split='train',
        ...
        self.data_split = data_split # train, val, or test
        ...
        if self.data_split in ['train', 'val']:
            ...
            raise Exception('Unkown split {}'.format(self.data_split))
